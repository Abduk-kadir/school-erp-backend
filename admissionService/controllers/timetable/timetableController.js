...
const timetableController = {
  ...
  getAll: asyncHandler(async (req, res) => {
    ...
    const fromJoins = `from timetables as tm
   ...
   left join StaffRegistrations as sf on tm.staffid = sf.id`;
    ...
    const query = `select tm.*, bt.batch_name, cm.class_name, dv.division_name, CONCAT_WS(' ', sf.surname, sf.firstname) as staff_name ${fromJoins}
   ${whereSql}
