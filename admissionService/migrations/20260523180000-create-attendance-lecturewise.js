...
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE attendance_lecturewises (
        id BIGINT NOT NULL AUTO_INCREMENT,
        reg_no BIGINT NOT NULL,
        attendance_date DATE NOT NULL,
        subjectid INTEGER NULL,
        attendance TINYINT NOT NULL DEFAULT 0 COMMENT '0=absent, 1=present',
        staffid INTEGER NULL,
        createdAt DATETIME NOT NULL,
        updatedAt DATETIME NOT NULL,
        PRIMARY KEY (id, attendance_date),
        UNIQUE KEY uk_lec_reg_date_subject (reg_no, attendance_date, subjectid),
        KEY idx_lec_attendance_date (attendance_date),
        KEY idx_lec_reg_no_attendance (reg_no, attendance)
      )
  ...
  async down(queryInterface) {
    await queryInterface.dropTable('attendance_lecturewises');
  },
};
