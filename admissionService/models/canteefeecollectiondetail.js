...
module.exports = (sequelize, DataTypes) => {
  class canteefeecollectiondetail extends Model {
    static associate(models) {
      canteefeecollectiondetail.belongsTo(models.par_student_personal_information, {
        foreignKey: 'reg_no',
        targetKey: 'reg_no',
        as: 'student',
      });

      canteefeecollectiondetail.belongsTo(models.canteenfeecollection, {
        foreignKey: 'fee_table_id',
        targetKey: 'id',
        as: 'feeCollectionInfo',
      });

      canteefeecollectiondetail.belongsTo(models.FeeHead, {
  ...
  canteefeecollectiondetail.init(
    {
    ...
    {
      sequelize,
      modelName: 'canteefeecollectiondetail',
      indexes: [{ fields: ['fee_table_id'], name: 'canteefeecollectiondetails_fee_table_id_idx' }],
    }
  );

  return canteefeecollectiondetail;
};
