...
module.exports = (sequelize, DataTypes) => {
  class transportfeecollectiondetail extends Model {
    static associate(models) {
      transportfeecollectiondetail.belongsTo(models.par_student_personal_information, {
        foreignKey: 'reg_no',
        targetKey: 'reg_no',
        as: 'student',
      });

      transportfeecollectiondetail.belongsTo(models.transportfeecollection, {
        foreignKey: 'fee_table_id',
        targetKey: 'id',
        as: 'feeCollectionInfo',
      });

      transportfeecollectiondetail.belongsTo(models.FeeHead, {
  ...
  transportfeecollectiondetail.init(
    {
    ...
    {
      sequelize,
      modelName: 'transportfeecollectiondetail',
      indexes: [
        { fields: ['fee_table_id'], name: 'transportfeecollectiondetails_fee_table_id_idx' },
      ],
    }
  );

  return transportfeecollectiondetail;
};
