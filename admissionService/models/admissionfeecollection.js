...
module.exports = (sequelize, DataTypes) => {
  class admissionfeecollection extends Model {
    static associate(models) {
      admissionfeecollection.belongsTo(models.par_student_personal_information, {
        foreignKey: 'reg_no',
        targetKey: 'reg_no',
        as: 'student',
      });

      admissionfeecollection.hasMany(models.admissionfeecollectiondetail, {
        foreignKey: 'fee_table_id',
        as: 'admissionFeeCollectionDetails',
      });
      admissionfeecollection.hasMany(models.studentfine, {
        foreignKey: 'fee_table_id',
        as: 'studentFines',
      });
    }
  ...
  admissionfeecollection.init(
    ...
    {
      sequelize,
      modelName: 'admissionfeecollection',
      indexes: [{ fields: ['reg_no'], name: 'admissionfeecollections_reg_no_idx' }],
    }
  );
