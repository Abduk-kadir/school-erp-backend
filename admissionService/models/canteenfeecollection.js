...
module.exports = (sequelize, DataTypes) => {
  class canteenfeecollection extends Model {
    static associate(models) {
      canteenfeecollection.belongsTo(models.par_student_personal_information, {
        foreignKey: 'reg_no',
        targetKey: 'reg_no',
        as: 'student',
      });

      canteenfeecollection.hasMany(models.canteefeecollectiondetail, {
        foreignKey: 'fee_table_id',
        as: 'canteeFeeCollectionDetails',
      });

      canteenfeecollection.hasMany(models.studentfine, {
        foreignKey: 'fee_table_id',
        as: 'studentFines',
      });
    }
  ...
  canteenfeecollection.init(
    ...
    {
      sequelize,
      modelName: 'canteenfeecollection',
      indexes: [{ fields: ['reg_no'], name: 'canteenfeecollections_reg_no_idx' }],
    }
  );

  return canteenfeecollection;
};
